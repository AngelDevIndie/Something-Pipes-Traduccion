...
hHotTap_Interact$0: ; 0 args
	...
	memwrite4 ax
	sourceline 41
	li ax, "Squeak. That\'s enough of that."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000000247: ; inside hHotTap_Interact$0, ; referenced by 1 spots
	...
	farsubsp 1
	sourceline 49
	li ax, "...Hm. It\'s getting a bit steamy in here."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000000397: ; inside hColdTap_Interact$0, ; referenced by 1 spots
	...
	memwrite4 ax
	sourceline 67
	li ax, "Squeak. Nice and cold now."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
oDrain_Look$0: ; 0 args
	...
	li ax, "It\'s way too dark to see anything down there."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000000593: ; inside oDrain_Look$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Hmm. Everything looks clear down there."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Maybe it\'s on a separate water line\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a No, no, that\'s ridiculous."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000000704: ; inside oDrain_Look$0, ; referenced by 1 spots
	sourceline 85
	li ax, "Hold on. There\'s something in the drainpipe."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
BloodyItem$1: ; 1 args
	...
	sourceline 91
	push op
	li ax, "Drenched in red and lacking the glint in it\'s eye. What have you seen, Cool Ranch\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iDuck
...
label000000000830: ; inside BloodyItem$1, ; referenced by 1 spots
	...
	sourceline 95
	push op
	li ax, "The bristles are stained dark red. Was the wood always this old and cracked...\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iBroom
...
oDrain_Interact$0: ; 0 args
	...
	li ax, "My arm won\'t fit in there."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000000999: ; inside oDrain_Interact$0, ; referenced by 1 spots
	sourceline 109
	li ax, "There\'s definitely something in there. Just got to wiggle it loose, and..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "It\'s the duck! I didn\'t think it was *that* flexible..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Doesn\'t matter. Glad to have you back."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000001208: ; inside oDrain_Interact$0, ; referenced by 1 spots
	...
	sourceline 116
	li ax, "Hold on- something\'s tied to it\'s base with... is that yarn\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 117
	li ax, "A box of matches\? How did those get down there\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000001370: ; inside oDrain_Interact$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "%a I... I should wipe this off."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
oWater_Look$0: ; 0 args
	...
	thisaddr 1711
	sourceline 154
	li ax, "Crystal clear, unlike the bath. How very strange."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 155
	li ax, "...I should stop wasting water. We\'re in a drought."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
CleanItem$1: ; 1 args
	...
	sourceline 161
	push op
	li ax, "I\'ve wiped off all the blood, but something still seems... wrong. What have you seen, duck\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iDuck
...
label000000001863: ; inside CleanItem$1, ; referenced by 1 spots
	...
	sourceline 166
	push op
	li ax, "The only proof of what it\'s been through is the stained bristles. How on Earth did it fit through the pipes\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iBroom
...
label000000001955: ; inside CleanItem$1, ; referenced by 2 spots
	...
	li ax, 0
	farpush ax
	li ax, "%a Well. As clean as it\'s ever going to get."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
