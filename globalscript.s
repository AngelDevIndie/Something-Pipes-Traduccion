...
label000000000609: ; inside unhandled_event$2, ; referenced by 1 spots
	...
	memread4 ax
	farpush ax
	li ax, "Algo se ha jodido. Díselo a CJ Hotspot, %d."
	farpush ax
	setfuncargs 2
	li ax, Display
	farcall ax
...
label000000000936: ; inside unhandled_event$2, ; referenced by 1 spots
	...
	memread4 ax
	farpush ax
	li ax, "Algo se ha jodido. Díselo a CJ Object, %d."
	farpush ax
	setfuncargs 2
	li ax, Display
	farcall ax
...
label000000001078: ; inside unhandled_event$2, ; referenced by 1 spots
	sourceline 112
	li ax, "No están de humor para hablar."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000001128: ; inside unhandled_event$2, ; referenced by 1 spots
	...
	memread4 ax
	farpush ax
	li ax, "Algo se ha jodido. Díselo a CJ Character, %d."
	farpush ax
	setfuncargs 2
	li ax, Display
	farcall ax
...
iCup_Interact$0: ; 0 args
	...
	sourceline 394
	push op
	li ax, "No creo que beber esto sea prudente."
	farpush ax
	li mar, player
	push mar
	pop mar
...
Button1_OnClick$2: ; 2 args
	...
	li ax, "Guardar/Cargar no está disponible en la versión web, ¡lo sentimos!"
	farpush ax
	setfuncargs 1
	li ax, Display
	farcall ax
...
label000000014308: ; inside cClarissa_Interact$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¿Qué voy a hacer conmigo misma\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000014392: ; inside cClarissa_Interact$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¿Es demasiado tarde para volver a la cama\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "... No, no, tengo que arreglar esto."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
cClarissa_Look$0: ; 0 args
	...
	thisaddr 15831
	sourceline 637
	li ax, "Uf... tengo el pelo tan grasiento. Apuesto a que lo tengo pegajoso ahora mismo."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000015954: ; inside cClarissa_UseInv$0, ; referenced by 1 spots
	sourceline 652
	li ax, "Barrer las cosas bajo la alfombra es lo que mejor se me da."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000016004: ; inside cClarissa_UseInv$0, ; referenced by 1 spots
	...
	pop op
	sourceline 661
	li ax, "Parecen bastante sabrosa-"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 663
	li ax, "No, no. No se come más cera. No tienes seis años."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000016113: ; inside cClarissa_UseInv$0, ; referenced by 1 spots
	sourceline 667
	li ax, "Me los pondré cuando tenga una misión específica en mente."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 668
	li ax, "... En otras palabras, debería usarlos en otra cosa."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000016156: ; inside cClarissa_UseInv$0, ; referenced by 1 spots
	sourceline 672
	li ax, "Sólo sostener esta cosa me da mala espina."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
btnSave_OnClick$2: ; 2 args
	...
	sourceline 686
	li ax, "Aquí no hace falta guardar. La pantalla de título no puede hacerte daño."
	farpush ax
	setfuncargs 1
	li ax, Display
	farcall ax
...
label000000016458: ; inside btnSave_OnClick$2, ; referenced by 1 spots
	...
	sourceline 696
	li ax, "Introduce un nombre para tu partida guardada."
	farpush ax
	setfuncargs 1
	li ax, Display
	farcall ax
...
label000000016911: ; inside btnSave_OnClick$2, ; referenced by 1 spots
	sourceline 726
	li ax, "Has alcanzado el número máximo de 20 de guardados. Por favor, borra un par."
	farpush ax
	setfuncargs 1
	li ax, Display
	farcall ax
...
label000000017067: ; inside btnDelSave_OnClick$2, ; referenced by 1 spots
	sourceline 738
	li ax, "Selecciona una partida guardada para eliminarla."
	farpush ax
	setfuncargs 1
	li ax, Display
	farcall ax
...
btnLoad_OnClick$2: ; 2 args
	...
	sourceline 757
	li ax, "Selecciona una partida guardada para cargarla."
	farpush ax
	setfuncargs 1
	li ax, Display
	farcall ax
