...
_run_dialog2$1: ; 1 args
	...
	pop op
	sourceline 10
	li ax, "¿Qué le pasa al agua\? Está roja, y pegajosa... y..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "Eso no puede ser sangre. ¿No\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000002413: ; inside _run_dialog2$1, ; referenced by 1 spots
	...
	pop op
	sourceline 22
	li ax, "No. No seas estúpida, Clarissa. Sabes lo que hiciste anoche."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 23
	li ax, "Seis horas atendiendo la tienda. Y dos horas más después del cierre, limpiando lo que dejaron esos niñatos."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 26
	li ax, "No hay lugar para... para lagunas asesinas en esa línea temporal."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 31
	li ax, "Tal vez revise las imágenes de seguridad de la tienda más tarde. Por si acaso."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000002914: ; inside _run_dialog2$1, ; referenced by 1 spots
	...
	pop op
	sourceline 39
	li ax, "Ahora que lo pienso, han pasado... ¿cuánto, 18 horas desde que estuve aquí\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "Alguien podría haberse colado a hurtadillas en ese tiempo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	pop op
	sourceline 46
	li ax, "Te habrías dado cuenta si tu apartamento estaba abierto. También habrías notado el olor."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 48
	li ax, "Además, no hay cuerpo. Y una persona no puede sangrar *tanto*."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000003340: ; inside _run_dialog2$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¿Cuántas tiendas más hay conectadas en esta tubería\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	pop op
	sourceline 56
	li ax, "¿Quizá alguien tiró un litro de pintura por el lavabo\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "Claro que no huele a pintura..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000003675: ; inside _run_dialog2$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "No puede ser sangre real. Simplemente no puede ser."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	pop op
	sourceline 69
	li ax, "¿Tal vez sea algún tipo de óxido\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 72
	li ax, "Dudo que el ayuntamiento haya revisado la cañería en mucho tiempo."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 73
	li ax, "Podría ser una acumulación de plantas o suciedad."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 75
	li ax, "Suciedad extremadamente roja."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 79
	li ax, "Últimamente las tuberías crujen más de lo normal..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000004165: ; inside _run_dialog2$1, ; referenced by 1 spots
	...
	pop op
	sourceline 90
	li ax, "Vale. Quedarme embobada no cambia el hecho de que necesito una ducha."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 91
	li ax, "Puedo lidiar con un atasco. Puede que tenga que saltarme el desayuno, pero--"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 97
	li ax, "¿Quién puede ser a estas horas\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
_run_dialog3$1: ; 1 args
	...
	li ax, 0
	farpush ax
	li ax, "... Video Nueve. Clarissa al habla."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Ingrid\? Son las cuatro de la mañana. ¿Por qué estás despierta\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Uhh, sí, bueno... Dijiste que debíamos avisar con dos horas de antelación si no podemos ir. ¿Verdad\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Genial. Porque he comido algo que me ha sentado mal. Estoy REALMENTE fatal. Cagándome por todas partes."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Así que no puedo abrir hoy. Lo siento."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Déjame adivinar. Olvidaste que tenías que estudiar."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Sí, el examen es dentro de ocho horas."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "De acuerdo. Vete a dormir."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Qué tal si TÚ te vas a dormir\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Tengo una tienda que atender y una ducha que arreglar, Ingrid."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Espera, ¿qué le pasa a tu ducha\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "No lo sé. El desagüe de la bañera está atascado y tiene un líquido rojo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Así que... tirar el cuerpo por el retrete no funcionó, o..."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¡Es broma! Caramba. Pero en serio, eso es espeluznante."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Es un fastidio, eso es lo que es."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a ¡F-a-n-t-a-s-maaaaaaaaaaaaaaaaaa!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Qué tal si culpamos a Sadako DESPUÉS de que un fontanero descarte todo lo demás\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Un fontanero\? ¿Antes del mediodía\? Sí, buena suerte con eso."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Oye, llámame si pasa algo raro, ¿quieres? Estoy interesada en esto."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Además, si no me tomo un descanso cada cinco minutos creo que me va a estallar la cabeza."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	farsubsp 1
	sourceline 45
	li ax, "*Suspiro* Estaría bien tener a alguien de mi edad a quien pedir consejo, pero supongo que con Ingrid bastará."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 46
	li ax, "Además. Si está empeñada en estar llamando toda la noche, supongo que no puedo empeorar las cosas."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000006292: ; inside _run_dialog4$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Residencia Zheng, al habla Zheng."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Hola Ingrid. Debo decir que tus modales telefónicos han mejorado mucho estos últimos meses."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a ... Aunque siga siendo un poco redundante."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000006475: ; inside _run_dialog4$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Me lo imaginaba. Oye, ¿sabes si hay una manera de hacer que el timbre sea más silencioso\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a No quiero que mamá piense que estoy vendiendo metanfetaminas otra vez."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Esto plantea varias preguntas."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Su lógica es muy rara y cuando no ha dormido bien tan sólo empeora."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Hm. Intenta cubrirlo con una almohada."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Lo haré. De todos modos, ¿qué pasa\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000006742: ; inside _run_dialog4$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Tío, tienes mucho eco. ¿Hay algo mal en la...\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Espera, ¿tienes el teléfono fijo en el baño\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Tienes que relajarte. De todos modos, ¿qué pasó esta vez\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000006939: ; inside _run_dialog4$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Lo siento, quiero decir hola. Me distraje con la práctica. Eso me ha estado molestando durante una hora."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000007136: ; inside _run_dialog4$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Buenos - *YAWN* - días. Residencia Zheng."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Agradezco el mantenimiento de las formalidades telefónicas."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Ja, ja, ja... sí. Puede que haya pedido a un número equivocado algo de café en polvo para esnifar hace unos minutos..."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000007298: ; inside _run_dialog4$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "... Ingrid, suenas agotada. Vete a dormir."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Cómo voy a hacerlo si sigues llamándome\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Por favor no, tengo el álgebra ardiendo en mis globos oculares."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000007495: ; inside _run_dialog4$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Casa Zheng, al habla Ingrid."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Hola de nuevo. Hay algo que quería preguntarte."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000007607: ; inside _run_dialog4$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Por Dios, Sra. D. Acabo de colgar el teléfono."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a De todas formas, ¿qué pasa\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000007913: ; inside _run_dialog5$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Me vendría bien tu punto de vista sobre algo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000007977: ; inside _run_dialog5$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¿Cómo te van los estudios\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Vale. ¿Por qué lo has vuelto a dejar para el último momento\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Tía, ¿sabes lo difícil que es conseguir silencio en esta casa\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Las mañanas son el único momento en que NO estoy trabajando y mamá NO está respirando en mi cuello."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Quizá tengas razón. Tal vez debería haberme ido a la cama."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "No es que unas pocas horas vayan a jod--"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a joder... ¡me va a explotar la cabeza!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Seguro que no quieres que vaya\? Me parece menos pérdida de tiempo que%DW"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "No vas a tirar tus notas a la basura sólo para ayudarme a arreglar una tubería."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Tienes algún truco para calcular la circunferencia media del cráneo de un adolescente\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000008752: ; inside _run_dialog5$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¡Buena suerte ahí dentro, Peter Venkman!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000008794: ; inside _run_dialog5$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¡No te resbales y te rompas la cabeza con la taza del váter!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000008836: ; inside _run_dialog5$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Ya sabes dónde encontrarme, Mario Bro."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000008878: ; inside _run_dialog5$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¡Saluda a los ghouls de mi parte!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000008962: ; inside _run_dialog5$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¡A salvo con el exorcismo!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000009584: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "A decir verdad, Ingrid, no tengo ni idea de lo que estoy haciendo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Nunca había tenido que desatascar mi propio baño."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Por qué no intentas deshacerte de la mugre\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "No, tonta. Me refiero a usar el desagüe."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Sabes qué lo está obstruyendo\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a ¿Dejaste el tapón puesto\? ¿Hay un brazo saliendo de la tubería\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Es difícil de decir sólo mirando. Y preferiría no tocar... lo que quiera que sea esto."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Bueno, yo no voy a hacerlo por ti."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a ¿Tal vez puedas soltarlo con algo\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "No sé. Es tu baño. Mira a tu alrededor."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000010005: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Tengo un caso hipotético para ti, Ingrid."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Digamos que he quitado un atasco. Y sé que lo he quitado. Pero el agua no desagua."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¡Pues tampoco parece cosa de fontanería!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Entonces tal vez deberíamos empezar a hablar de espectros."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000010293: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¿Crees...? ¿Realmente crees que podría ser un fantasma\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Eh\? Estaba citando esa película que pusieron en la tele el otro día."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a "Compañeros de piso", o algo así."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000010558: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Independientemente de si se trata o no de un fantasma de verdad, pensemos en ello como si lo fuera."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Imaginemos que hay un fantasma en mi cuarto de baño. ¿Cómo lo eliminarías\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Uhh... No lo sé. Haz lo que hacen en las películas, supongo."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Como dijiste, los fantasmas no son fáciles de ver, ¿verdad\? Siempre están escondidos, o invisibles, o lo que sea."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Así que tal vez tengas que encontrar una manera de hablar con él."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Esto empieza a ser ridículo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Tú eres la friki del cine. Todo lo que sé es que las luces suelen estar apagadas en esas escenas."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Y suele haber mucha niebla."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Porque es más difícil ver los defectos de las marionetas cuando todo lo que tienes es la luz de las velas y el vapor."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¡Aun así! Estoy segura de que algo de lo que has visto te dará una pista."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000010937: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Ey, Ingrid. Adivina lo que encontré."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¡Eh! ¡Lo sabía! ¡TIENES una colección de patos de goma!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "No es mío. Es de un amigo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "De todas formas, deja de ser tan aguafiestas Sra. D. Haz flotar a ese chico malo."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000011233: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Entonces encontré un viejo pato de goma en uno de mis armarios..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¡Eh! ¡Lo sabía! ¡Los coleccionas!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a De todas formas he oído que los patos son muy buenos ayudando a la gente a resolver problemas. El tuyo podría tener un título en fontanería."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Este parece un vago. Está por ahí flotando."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Quizá no pueda trabajar en estas condiciones. ¿Lo has pensado alguna vez\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Le has dado materiales básicos de fontanería\? ¿Tonta\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000011522: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Y la luz está probablemente en sus ojos. Idiota."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000011565: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Tengo malas noticias sobre Cool Ranch."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Oh, mierda, ¿el Buyer's Direct está retirando del mercado todos los aderezos para ensaladas\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a sobre el patito de goma de mi amigo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Lo dejé caer en la bañera y se hundió como una roca."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Eso es lo más triste que he oído decir a una cuarentona."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Tengo veintinueve, Ingrid%DW"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Seguro que no se cayó de la bañera cuando no mirabas\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Pon una luz ahí. A ver dónde fue."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000011957: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Entonces mi lavabo explotó."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Ahora que lo mencionas, ya sabes, he oído que suceden cosas así."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Después de que el agua se cierra o se atasca durante un tiempo hay como... ¿burbujas de aire\? ¿En las tuberías\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Y cuando vuelves a abrirlo, el grifo hace SPLWWWSSHSHSHHHHSHSHSHSHHH."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Ten cuidado al apagar y encender las cosas, supongo. Primero asegúrate de que no hay nada ahí abajo."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000012231: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Tío, suenas muy asustado. Cuéntame."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a No, está... bien. Sólo estoy cansada y enojada e imaginando mierdas."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	pop op
	sourceline 136
	li ax, "Tiene que ser una broma. Probablemente sea una broma de ELLA."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 137
	li ax, "No es difícil falsificar la escritura en el espejo. Basta con un poco de grasa para bloquear la condensación, y..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 138
	li ax, "Sea cual sea el remate de esta gilipollez, seguro que lo encuentro cerca de esa flecha."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "%a Me alegro de que llames para no decirme nada."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000012734: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Ingrid, voy a preguntarte algo con toda seriedad. Y necesito que tú también respondas con seriedad."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Vale... extrañamente intensa pero ¿qué pasa\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Has usado, en algún momento de la semana pasada, el baño de arriba\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Estás segura\? Porque si esto es otra broma..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Tío, te lo he dicho como cinco veces, el baño de la tienda es asqueroso y el de tu apartamento no es mejor."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Yo uso el baño del Git Fit."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Y nunca te has colado allí con otro propósito, ni has escondido nada detrás de ninguno de mis armarios."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Oh, tío, has encontrado algo, ¿no\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Sí. Parece un colgante de ámbar."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Tiene una mantis religiosa dentro."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Y creo... creo que la cosa de la bañera..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Te estás quedando *conmigo*\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Sra. D, usted es mi jefa y es capaz de arruinarme financieramente si quisiera."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Así que sepa que digo esto con eso en mente:"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Tire esa cosa a un contenedor y busque otro sitio donde orinar."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000013533: ; inside _run_dialog7$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Oh, ¿quieres hablar de otra cosa\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000013673: ; inside _run_dialog8$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "%a La mujer que plancha sus faldas vaqueras cree en fantasmas."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Es difícil expresarlo con palabras, pero..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Creo que es una tontería suponer que sé lo que pasa después de la muerte."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a No cuando sé tan poco sobre la vida."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Y ahora mi bañera está sangrando. Así que o la vida es muy rara, o es otra cosa."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Estooooo se está volviendo demasiado real para mí, jefa."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000013982: ; inside _run_dialog8$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "No lo sé. La mayoría de las historias de fantasmas son sobre gente que no puedes ver."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "No puedo argumentar con rotundidad sobre la existencia de algo -o alguien- tan intangible."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Así que no vale la pena pensar en ello."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Bueno, una de esas personas invisibles podría estar manifestando lodo en tu baño."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Y hay muchas otras cosas que podrían estar causándolo también."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Así que en lugar de discutir sobre la causa, centrémonos en solucionar los síntomas."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000014256: ; inside _run_dialog8$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "No me mientas, vives para esa mierda."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Primero, cuida tu lenguaje. Y segundo, vivo para el *horror*."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Que me guste ver una decapitación con efectos reales no significa que crea que hay gente invisible en mi casa."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Gente invisible\? S-Sra. Dunst..."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a VIENE DE DENTRO DEL-%DONTWAIT"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¡No puedes probar que no, tío! ¡Sé dónde vives!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "No me hagas revisar las cámaras de mis calzoncillos, Ingrid."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000014705: ; inside _run_dialog8$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¡Cállate! ¡No tengo que aguantar esto de una teórica de Benjamin Evergreen!"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Vale, ¿pero mi teoría tiene sentido? Viste el documental en SBS, el tipo es demasiado talentoso para haber sido asesinado por la mafia."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Tendría 104 años, Ingrid. No."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¡Sigue teniendo más sentido que pensar que hay gente invisible en tu casa!"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
_run_dialog24$1: ; 1 args
	...
	li ax, 0
	farpush ax
	li ax, "%aIndependientemente de si se trata de un fantasma de verdad, pensemos en ello como si lo fuera."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
_run_dialog9$1: ; 1 args
	...
	li ax, 0
	farpush ax
	li ax, "%aPor lo menos creo que es ámbar."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	pop op
	sourceline 15
	li ax, "¿Qué hace en mi baño\? ¿Nunca he limpiado la parte de atrás del lavabo\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 17
	li ax, "Y... si realmente hay algo en la bañera..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
_run_dialog10$1: ; 1 args
	...
	li ax, 0
	farpush ax
	li ax, "Esto es lo que buscas, ¿verdad\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a ¿Este collar, y luego me dejarás en paz\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000016401: ; inside _run_dialog10$1, ; referenced by 1 spots
	...
	sourceline 22
	li ax, "A decir verdad, que le den."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000017029: ; inside _run_dialog10$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "%a ¿Podrías ahora salir de mi bañera, por favor\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Qué demonios estoy haciendo\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Esto es una total pérdida de tiempo%DONTWAIT"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000017310: ; inside _run_dialog10$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "%a Esto es una total pérdida de tiempo--"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000017952: ; inside _run_dialog10$1, ; referenced by 1 spots
	...
	pop op
	sourceline 108
	li ax, "Es increíble que dejara que Ingrid me convenciera de que era un completa *chorrada*."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "%aSólo queda ir a trabajar, supongo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000020262: ; inside _run_dialog11$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Ha llamado al contestador automático de Video Nine. El horario comercial es de 8 a 23 horas."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Por favor, deje un mensaje, y uno de nuestros amables empleados le-%DONTWAIT"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
_run_dialog12$1: ; 1 args
	...
	li ax, 0
	farpush ax
	li ax, "%a Yo-soy yo. Usted- usted no contestaba, así que yo-"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Mire, voy a entrar. Por favor, póngase los pantalones..."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Euughh... aquí huele a cloaca..."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	pop op
	sourceline 32
	li ax, "La Sra. Dunst no bromeaba. Eso... eso REALMENTE parece sangre."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 36
	li ax, "¿Es una broma\? No, ella... oh tío, ¿y si de verdad se ha hecho daño\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "¿Debería llamar a la policía\? Definitivamente debería llamar a la policía%DW"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000022152: ; inside _run_dialog12$1, ; referenced by 2 spots
	...
	li ax, 0
	farpush ax
	li ax, "GAAAAAAAAAAAAAAAAAAAAAAAA JODER- %DONTWAIT"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿PODRÍAN AYUDARNOS, POR FAVOR\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000022430: ; inside _run_dialog12$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "AAAAAAAAAAGHHHH NECESITO UN DESATASCADOR"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000022467: ; inside _run_dialog12$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¿PUEDEN AYUDARME, POR FAVOR\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
_run_dialog23$1: ; 1 args
	...
	li ax, 0
	farpush ax
	li ax, "¿Debería llamar a la policía\? Definitivamente debería llamar a la policía--"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000024195: ; inside _run_dialog23$1, ; referenced by 2 spots
	...
	li ax, 0
	farpush ax
	li ax, "GAAAAAAAAAAAAAAAAAAAAAAAA JODER-"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
_run_dialog17$1: ; 1 args
	...
	pop op
	sourceline 16
	li ax, "Agh... mi pelo está asqueroso."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "Disculpe. Busco a la dueña."
	newstr ax
	farpush ax
	li mar, cPlumber
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Me han llamado por una tubería atascada."
	newstr ax
	farpush ax
	li mar, cPlumber
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a El baño está arriba. La puerta está allí."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Por lo menos ha venido rápido."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Esto va a costar una fortuna-"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	pop op
	sourceline 41
	li ax, "*sfx: se oyen gritos desde arriba*"
	farpush ax
	setfuncargs 1
	li ax, Display
	farcall ax
...
label000000025885: ; inside _run_dialog17$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Esto va a costar una fortuna-%DONTWAIT"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000026010: ; inside _run_dialog17$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Ohhhhhhhhhhhhhhhhhhhhhhhhhhhh mierda-"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000026639: ; inside _run_dialog18$1, ; referenced by 1 spots
	...
	farsubsp 1
	sourceline 19
	li ax, "¿Qué voy a hacer\? No puedo seguir dependiendo de las duchas del gimnasio."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 21
	li ax, "Quizá estoy exagerando. Tal vez *debería* llamar a un fontanero."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "Sé que quería que me repusiera, pero... uhh..."
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Creo que puede haber algún problema con la última entrega\?"
	newstr ax
	farpush ax
	li mar, cIngrid
	mr ax, mar
...
label000000028062: ; inside _run_dialog19$1, ; referenced by 1 spots
	...
	li ax, "Ya hay suficiente grasa para los dedos ahí."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000028123: ; inside _run_dialog19$1, ; referenced by 1 spots
	...
	sourceline 30
	li ax, "Hmm. Ahora que lo pienso, esto se parece al sello de espiritismo que usaron en la película Mansión Miranda."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 31
	li ax, "Por supuesto, no pasa nada. Todo es un montón de tonterías."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 32
	li ax, "... ¿A menos que me haya saltado un paso\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 33
	li ax, "Lo que sea. Dejaré que el vapor limpie esto."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000028298: ; inside _run_dialog19$1, ; referenced by 1 spots
	sourceline 43
	li ax, "Ahí está. Un sello de espiritismo hortera de una película hortera."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 44
	li ax, "¿Estoy realmente tan desesperada por una ducha que estoy intentando *esto*\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000028721: ; inside _run_dialog19$1, ; referenced by 1 spots
	sourceline 65
	li ax, "Es divertido. Dejaré que el vapor lo limpie."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000029532: ; inside _run_dialog20$1, ; referenced by 1 spots
	...
	li ax, "Ahí está. Mi reflejo está ahora prohibido."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000031162: ; inside _run_dialog21$1, ; referenced by 1 spots
	...
	li ax, "Añadimos unos alienígenas..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000032419: ; inside _run_dialog0$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Tengo que usar más el hilo dental."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000032782: ; inside _run_dialog0$1, ; referenced by 1 spots
	sourceline 27
	li ax, "El cristal está completamente empañado. Probablemente sea lo mejor."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000032808: ; inside _run_dialog0$1, ; referenced by 1 spots
	...
	li ax, "Al menos con las luces apagadas no tengo que mirar lo que hace mi pelo."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000032858: ; inside _run_dialog0$1, ; referenced by 1 spots
	sourceline 35
	li ax, "El cristal está oscuro y completamente empañado."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 36
	li ax, "En otras palabras, tiene una visibilidad ideal."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
_run_dialog6$1: ; 1 args
	...
	li ax, "Tal vez debería ir a trabajar..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000033037: ; inside _run_dialog6$1, ; referenced by 1 spots
	sourceline 9
	li ax, "Esto se está poniendo raro. Realmente raro. Probablemente alguien me está jodiendo, pero..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 10
	li ax, "¿Merece la pena quedarse para averiguarlo\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000033081: ; inside _run_dialog6$1, ; referenced by 1 spots
	...
	sourceline 17
	li ax, "Esto es un problema para un fontanero. O para un sacerdote."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 18
	li ax, "Cualquiera que no haga preguntas."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000033747: ; inside _run_dialog13$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Así que eres el famoso Cool Ranch."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Eras la comidilla del laboratorio de informática."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000033927: ; inside _run_dialog13$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Debe estar bien ser un pato."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Sin trabajar. Sin impuestos."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a No entiendo cómo se supone que funcionan las duchas.."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000034238: ; inside _run_dialog13$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¿Sabes hablar con los fantasmas\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Vamos, debes haberte juntado con unos cuantos tipos oscuros en tu vida."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Te haré hablar un día de estos."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000034499: ; inside _run_dialog13$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Perdón por casi sacrificarte a los dioses del baño oscuro."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Parecías más a prueba de sangre de lo que realmente eras."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000034746: ; inside _run_dialog13$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Me pregunto cómo estará su dueño."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Probablemente ahora es un gajillonario. Hackeando computadoras centrales. Reticulando ranuras."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%aLo que sea que hagan los programadores cuando se vuelven británicos."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000035183: ; inside _run_dialog13$1, ; referenced by 1 spots
	...
	pop op
	sourceline 72
	li ax, "Estoy hablando con un patito de goma."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
_run_dialog25$1: ; 1 args
	...
	farsubsp 2
	sourceline 5
	li ax, "Hola, bienvenido. Parece que ya has jugado a otra versión de Tuberías en este ordenador."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 6
	li ax, "Lamentablemente, los archivos guardados no son compatibles entre sí."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 7
	li ax, "¿Quieres borrar tus datos antiguos ahora\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000038131: ; inside _run_dialog25$1, ; referenced by 1 spots
	...
	sourceline 30
	li ax, "No hay ningún problema. Sus datos no han sido modificados."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
