...
oBathtub_Look$0: ; 0 args
	...
	sourceline 118
	li ax, "Una tomadura de pelo. Una absoluta pérdida de mi tiempo."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000001584: ; inside oBathtub_Look$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Rojo sangre, y muy pegajoso..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Agh. Es nauseabundo de ver."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000001739: ; inside oBathtub_Look$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "¿Dónde se ha ido\? No puedo ver el fondo con las luces apagadas."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000001776: ; inside oBathtub_Look$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Creo que oigo algo moviéndose ahí dentro, pero es difícil ver nada con las luces apagadas."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000001853: ; inside hDoor_Interact$0, ; referenced by 1 spots
	sourceline 145
	li ax, "Debería apagar la luz antes de irme. La factura de la luz ya es bastante alta."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
hCabinets_Look$0: ; 0 args
	...
	thisaddr 2233
	sourceline 192
	li ax, "Odio esas cosas. Siempre se quedan pegados."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
DuckDrop$0: ; 0 args
	...
	farcall ax
	sourceline 297
	li ax, "... Sería más bonito si no estuviera flotando en sangre."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
BroomNeutral$0: ; 0 args
	...
	li ax, 0
	farpush ax
	li ax, "Hay algo blando en el desagüe."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a ¿Una acumulación orgánica, quizás\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000004885: ; inside BroomNeutral$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Eso no puede estar bien... No puedo sentir el fondo de la bañera."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Y desde luego no es tan profunda."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
BroomSinister$0: ; 0 args
	...
	li ax, 0
	farpush ax
	li ax, "La obstrucción parece haber desaparecido, pero no desagua nada."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000005797: ; inside BroomSinister$0, ; referenced by 1 spots
	...
	pop op
	sourceline 385
	li ax, "¿DÓNDE DEMONIOS SE HA METIDO\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000007100: ; inside oBathtub_UseInv$0, ; referenced by 1 spots
	...
	sourceline 475
	li ax, "Prefiero no correr el riesgo de envenenarme."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000007523: ; inside oBathtub_UseInv$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Está todo en la botella. Espero no haber hecho gas cloro."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	pop op
	sourceline 503
	li ax, "Al menos eso aflojará lo que haya en el desagüe."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000007977: ; inside oBathtub_UseInv$0, ; referenced by 1 spots
	...
	li ax, "El hecho de que salieran completamente secos del desagüe es un milagro que no voy a arruinar todavía."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
oBathtub_Interact$0: ; 0 args
	...
	li ax, 0
	farpush ax
	li ax, "Estúpida, estúpida, estúpida."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Apuesto a que esa cosa fea estaba hecha de plástico."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Y el agua es probablemente champú rancio y colorante alimentario."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "Esto me pasa por contratar a un puñado de frikis."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000008493: ; inside oBathtub_Interact$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "%a ¿Estás ahí abajo, colega\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000008653: ; inside oBathtub_Interact$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "L... la escoba cayó hacia abajo, y la bañera no es tan profunda..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000008722: ; inside oBathtub_Interact$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Ufff... esos productos químicos no ayudaron ni al color ni al olor."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "%a Razón de más para no meter la mano ahí."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000008833: ; inside oBathtub_Interact$0, ; referenced by 1 spots
	...
	pop op
	sourceline 564
	li ax, "Tiene que haber una forma más inteligente de limpiar el desagüe que meter la mano ahí."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 566
	li ax, "Quién sabe qué tipo de enfermedades contraería."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
oCandles_Look$0: ; 0 args
	...
	li ax, 0
	farpush ax
	li ax, "A ver, ¿dónde se han metido las cerillas...\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000009184: ; inside oCandles_Look$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Ughhhh, citronela. Empiezo a recordar por qué las desterré al armario."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000009493: ; inside oCandles_Interact$0, ; referenced by 1 spots
	sourceline 609
	li ax, "Las dejaré por ahora. Me gusta el ambiente que desprenden."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000009980: ; inside oCandles_UseInv$0, ; referenced by 1 spots
	sourceline 634
	li ax, "Quizá si hubiera prestado atención en las Girl Scouts, sabría cómo encender un fuego con eso."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000010002: ; inside oCandles_UseInv$0, ; referenced by 1 spots
	sourceline 639
	li ax, "Quemar mi casa mediante experimentos aleatorios no está en mi lista de cosas por hacer."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
CleanItem$1: ; 1 args
	...
	sourceline 645
	push op
	li ax, "He limpiado toda la sangre, pero algo me sigue pareciendo... mal. ¿Qué te he hecho\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iDuck
...
label000000010132: ; inside CleanItem$1, ; referenced by 1 spots
	...
	sourceline 650
	push op
	li ax, "La única prueba de lo que ha pasado son las cerdas manchadas. ¿Cómo diablos pasó por la curva en U\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iBroom
...
label000000010224: ; inside CleanItem$1, ; referenced by 2 spots
	...
	li ax, 0
	farpush ax
	li ax, "Ya está. Limpio de nuevo - o tan limpio como puedo conseguir."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000010425: ; inside CleanItem$1, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "... Y he estropeado esta toalla."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	sourceline 666
	push op
	li ax, "Maldita sea. Es hora de replantearse ese adjetivo."
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, oTowel
...
label000000010648: ; inside oTowel_UseInv$0, ; referenced by 1 spots
	sourceline 678
	li ax, "No hay necesidad de limpiar eso."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
oLaundry_Interact$0: ; 0 args
	...
	li ax, 0
	farpush ax
	li ax, "Si no hay nada en los bolsillos, entonces..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	farsubsp 1
	sourceline 688
	li ax, "Hay algo en la parte de atrás del armario."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000010845: ; inside oLaundry_Interact$0, ; referenced by 1 spots
	sourceline 693
	li ax, "De acuerdo. No más excusas, tengo que lavar esto... Cuando acabe de arreglar la ducha."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
hSink_Look$0: ; 0 args
	...
	li ax, "Mi factura del agua se va a disparar si no lo arreglo."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000010967: ; inside hSink_Look$0, ; referenced by 1 spots
	sourceline 711
	li ax, "Me pregunto si mis problemas de fontanería tienen algo que ver con que lave los platos aquí..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	pop op
	sourceline 713
	li ax, "Seguro que no, pero... quizá debería pedir ese pomo de repuesto para la cocina por si acaso."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
