...
label000000000247: ; inside hHotTap_Interact$0, ; referenced by 1 spots
	...
	farsubsp 1
	sourceline 49
	li ax, "... Hm. Se está empañando un poco esto."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000000397: ; inside hColdTap_Interact$0, ; referenced by 1 spots
	...
	memwrite4 ax
	sourceline 67
	li ax, "Chirrido. Agradable y fría ahora"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
oDrain_Look$0: ; 0 args
	...
	li ax, "Está demasiado oscuro para ver nada ahí abajo."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000000593: ; inside oDrain_Look$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "Hmm. Todo parece despejado ahí abajo."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
	...
	li ax, 0
	farpush ax
	li ax, "¿Quizás está en una línea de agua separada\?"
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000000704: ; inside oDrain_Look$0, ; referenced by 1 spots
	sourceline 85
	li ax, "Un momento. Hay algo en el desagüe."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
BloodyItem$1: ; 1 args
	...
	sourceline 91
	push op
	li ax, "Empapado en rojo y sin brillo en los ojos. ¿Qué has visto, Cool Ranch\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iDuck
...
label000000000830: ; inside BloodyItem$1, ; referenced by 1 spots
	...
	sourceline 95
	push op
	li ax, "Las cerdas están manchadas de rojo oscuro. ¿La madera siempre fue así de vieja y agrietada...\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iBroom
...
label000000000999: ; inside oDrain_Interact$0, ; referenced by 1 spots
	sourceline 109
	li ax, "Definitivamente hay algo ahí. Sólo tengo que moverlo para soltarlo, y..."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	li ax, 0
	farpush ax
	li ax, "¡Es el pato! No pensé que fuera *tan* flexible..."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
label000000001208: ; inside oDrain_Interact$0, ; referenced by 1 spots
	...
	sourceline 116
	li ax, "Espera... algo está atado a su base con... ¿eso es hilo\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 117
	li ax, "¿Una caja de cerillas\? ¿Cómo llegó eso ahí abajo\?"
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
label000000001370: ; inside oDrain_Interact$0, ; referenced by 1 spots
	...
	li ax, 0
	farpush ax
	li ax, "%a Yo... Debería limpiar esto."
	newstr ax
	farpush ax
	li mar, cClarissa
	mr ax, mar
...
oWater_Look$0: ; 0 args
	...
	thisaddr 1711
	sourceline 154
	li ax, "Cristalina, a diferencia del baño. Qué extraño."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
	...
	farsubsp 1
	sourceline 155
	li ax, "... Debería dejar de desperdiciar agua. Hay sequía."
	newstr ax
	farpush ax
	setfuncargs 1
	li ax, Narrate
...
CleanItem$1: ; 1 args
	...
	sourceline 161
	push op
	li ax, "He limpiado toda la sangre, pero algo me sigue pareciendo... mal. ¿Qué has visto, pato\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iDuck
...
label000000001863: ; inside CleanItem$1, ; referenced by 1 spots
	...
	sourceline 166
	push op
	li ax, "La única prueba de lo que ha pasado son las cerdas manchadas. ¿Cómo demonios ha podido pasar por las tuberías\?"
	farpush ax
	li ax, "textLook"
	farpush ax
	li mar, iBroom
